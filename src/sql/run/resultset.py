        ...
        if _config_feedback_all():
            data_frame_footer = (
                (
                    ...
                    "'https://pandry.github.io/jupysql/integrations/pandas.html'>"
                    "<code>.DataFrame()</code></a> or to polars, call <a href="
                    "'https://pandry.github.io/jupysql/integrations/polars.html'>"
        ...
        if self._config.displaylimit != 0 and not self._done_fetching():
            displaylimit_footer = (
                (
                    ...
                    'Truncated to <a href="https://pandry.github.io/jupysql/'
