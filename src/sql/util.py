...
CONFIGURATION_DOCS_STR = "https://pandry.github.io/jupysql/api/configuration.html#loading-from-a-file"  # noqa
...
def find_close_match_config(word, possibilities, n=3):
    ...
    if not closest_matches:
        display.message_html(
            ...
            "<a href='https://pandry.github.io/jupysql/api/configuration.html#options'>"  # noqa
